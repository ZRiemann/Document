...
#include "install_crashdump_handler.h"
...
{	
	...
	{
		write_stderr("can not open crashdumps directory for write crash dump\n");
	}
...
void install_crashdump_handler(void)
{
